...
import com.vl.expressionparser.operation.Value;
import com.vl.expressionparser.operation.Variable;

import java.util.*;

class OperationChain {
    final private static Map<String, Integer> OPERATORS;
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            if (c.equals("(")) {
                ...
                if (literal.length() == 0 && !parenthesesWereAsLiteral)
                    ...
                    chains.add(new OperationChain(c, OPERATORS.get(c) + priority));
                }
            else if (!c.equals(" "))
